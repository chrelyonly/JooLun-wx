...
/*Table structure for table `wx_ma_security_result` */

DROP TABLE IF EXISTS `wx_ma_security_result`;

CREATE TABLE `wx_ma_security_result` (
...
/*Data for system application configuration and WeChat independent operation pages */

INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `route_name`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES
(2071, '微信账号配置', 1, 10, 'wxconfig', 'system/wxconfig/index', NULL, '', 1, 0, 'C', '0', '0', 'system:wxconfig:query', 'wechat', 'admin', '2026-09-07 00:00:00', '', NULL, '微信账号配置菜单'),
(2072, '商城配置', 1, 11, 'mallconfig', 'system/mallconfig/index', NULL, '', 1, 0, 'C', '0', '0', 'system:mallconfig:query', 'shopping', 'admin', '2026-09-07 00:00:00', '', NULL, '商城配置菜单'),
(2073, '微信配置查询', 2071, 1, '', NULL, NULL, '', 1, 0, 'F', '0', '0', 'system:wxconfig:query', '#', 'admin', '2026-09-07 00:00:00', '', NULL, ''),
(2074, '微信配置修改', 2071, 2, '', NULL, NULL, '', 1, 0, 'F', '0', '0', 'system:wxconfig:edit', '#', 'admin', '2026-09-07 00:00:00', '', NULL, ''),
(2075, '商城配置查询', 2072, 1, '', NULL, NULL, '', 1, 0, 'F', '0', '0', 'system:mallconfig:query', '#', 'admin', '2026-09-07 00:00:00', '', NULL, ''),
(2076, '商城配置修改', 2072, 2, '', NULL, NULL, '', 1, 0, 'F', '0', '0', 'system:mallconfig:edit', '#', 'admin', '2026-09-07 00:00:00', '', NULL, ''),
(2077, '模板消息', 4, 80, 'template-message', 'wxmp/template-message/index', NULL, 'WxMpTemplateMessage', 1, 0, 'C', '0', '0', 'wxmp:operations:query', 'message', 'admin', '2026-09-07 00:00:00', '', NULL, '公众号模板消息管理'),
(2078, '订阅消息', 2049, 20, 'subscribe-message', 'wxma/subscribe-message/index', NULL, 'WxMaSubscribeMessage', 1, 0, 'C', '0', '0', 'wxma:operations:query', 'message', 'admin', '2026-09-07 00:00:00', '', NULL, '小程序订阅消息管理'),
(2079, '公众号运营查询', 2077, 1, '', NULL, NULL, '', 1, 0, 'F', '0', '0', 'wxmp:operations:query', '#', 'admin', '2026-09-07 00:00:00', '', NULL, ''),
(2080, '公众号运营维护', 2077, 2, '', NULL, NULL, '', 1, 0, 'F', '0', '0', 'wxmp:operations:edit', '#', 'admin', '2026-09-07 00:00:00', '', NULL, ''),
(2081, '公众号消息发送', 2077, 3, '', NULL, NULL, '', 1, 0, 'F', '0', '0', 'wxmp:operations:send', '#', 'admin', '2026-09-07 00:00:00', '', NULL, ''),
(2082, '小程序运营查询', 2078, 1, '', NULL, NULL, '', 1, 0, 'F', '0', '0', 'wxma:operations:query', '#', 'admin', '2026-09-07 00:00:00', '', NULL, ''),
(2083, '小程序运营维护', 2078, 2, '', NULL, NULL, '', 1, 0, 'F', '0', '0', 'wxma:operations:edit', '#', 'admin', '2026-09-07 00:00:00', '', NULL, ''),
(2084, '小程序消息发送', 2078, 3, '', NULL, NULL, '', 1, 0, 'F', '0', '0', 'wxma:operations:send', '#', 'admin', '2026-09-07 00:00:00', '', NULL, ''),
(2085, '参数二维码', 4, 90, 'qrcode', 'wxmp/qrcode/index', NULL, 'WxMpQrcode', 1, 0, 'C', '0', '0', 'wxmp:operations:edit', 'code', 'admin', '2026-09-07 00:00:00', '', NULL, '公众号参数二维码'),
(2086, '运营数据分析', 4, 100, 'data-analysis', 'wxmp/data-analysis/index', NULL, 'WxMpDataAnalysis', 1, 0, 'C', '0', '0', 'wxmp:operations:query', 'chart', 'admin', '2026-09-07 00:00:00', '', NULL, '公众号官方数据分析'),
(2087, '客服工作台', 4, 110, 'customer-service', 'wxmp/customer-service/index', NULL, 'WxMpCustomerService', 1, 0, 'C', '0', '0', 'wxmp:operations:query', 'peoples', 'admin', '2026-09-07 00:00:00', '', NULL, '公众号客服账号、会话及消息'),
(2088, '群发管理', 4, 120, 'mass-message', 'wxmp/mass-message/index', NULL, 'WxMpMassMessage', 1, 0, 'C', '0', '0', 'wxmp:operations:query', 'clipboard', 'admin', '2026-09-07 00:00:00', '', NULL, '公众号群发及任务管理'),
(2089, '评论管理', 4, 130, 'comments', 'wxmp/comments/index', NULL, 'WxMpComments', 1, 0, 'C', '0', '0', 'wxmp:operations:query', 'edit', 'admin', '2026-09-07 00:00:00', '', NULL, '公众号图文评论管理'),
(2090, '小程序码', 2049, 30, 'qrcode', 'wxma/qrcode/index', NULL, 'WxMaQrcode', 1, 0, 'C', '0', '0', 'wxma:operations:edit', 'code', 'admin', '2026-09-07 00:00:00', '', NULL, '小程序码及二维码'),
(2091, '内容安全', 2049, 40, 'content-security', 'wxma/content-security/index', NULL, 'WxMaContentSecurity', 1, 0, 'C', '0', '0', 'wxma:operations:query', 'lock', 'admin', '2026-09-07 00:00:00', '', NULL, '小程序内容安全检测'),
(2092, '数据分析', 2049, 50, 'data-analysis', 'wxma/data-analysis/index', NULL, 'WxMaDataAnalysis', 1, 0, 'C', '0', '0', 'wxma:operations:query', 'chart', 'admin', '2026-09-07 00:00:00', '', NULL, '小程序官方数据分析'),
(2093, '发货及物流', 2049, 60, 'shipping', 'wxma/shipping/index', NULL, 'WxMaShipping', 1, 0, 'C', '0', '0', 'wxma:operations:query', 'list', 'admin', '2026-09-07 00:00:00', '', NULL, '小程序发货信息管理'),
(2094, '生成公众号二维码', 2085, 1, '', NULL, NULL, '', 1, 0, 'F', '0', '0', 'wxmp:operations:edit', '#', 'admin', '2026-09-07 00:00:00', '', NULL, ''),
(2095, '查询公众号数据', 2086, 1, '', NULL, NULL, '', 1, 0, 'F', '0', '0', 'wxmp:operations:query', '#', 'admin', '2026-09-07 00:00:00', '', NULL, ''),
(2096, '查询客服数据', 2087, 1, '', NULL, NULL, '', 1, 0, 'F', '0', '0', 'wxmp:operations:query', '#', 'admin', '2026-09-07 00:00:00', '', NULL, ''),
(2097, '维护客服账号和会话', 2087, 2, '', NULL, NULL, '', 1, 0, 'F', '0', '0', 'wxmp:operations:edit', '#', 'admin', '2026-09-07 00:00:00', '', NULL, ''),
(2098, '发送客服消息', 2087, 3, '', NULL, NULL, '', 1, 0, 'F', '0', '0', 'wxmp:operations:send', '#', 'admin', '2026-09-07 00:00:00', '', NULL, ''),
(2099, '查询群发任务', 2088, 1, '', NULL, NULL, '', 1, 0, 'F', '0', '0', 'wxmp:operations:query', '#', 'admin', '2026-09-07 00:00:00', '', NULL, ''),
(2100, '维护群发任务', 2088, 2, '', NULL, NULL, '', 1, 0, 'F', '0', '0', 'wxmp:operations:edit', '#', 'admin', '2026-09-07 00:00:00', '', NULL, ''),
(2101, '发送群发消息', 2088, 3, '', NULL, NULL, '', 1, 0, 'F', '0', '0', 'wxmp:operations:send', '#', 'admin', '2026-09-07 00:00:00', '', NULL, ''),
(2102, '查询公众号评论', 2089, 1, '', NULL, NULL, '', 1, 0, 'F', '0', '0', 'wxmp:operations:query', '#', 'admin', '2026-09-07 00:00:00', '', NULL, ''),
(2103, '维护公众号评论', 2089, 2, '', NULL, NULL, '', 1, 0, 'F', '0', '0', 'wxmp:operations:edit', '#', 'admin', '2026-09-07 00:00:00', '', NULL, ''),
(2104, '生成小程序码', 2090, 1, '', NULL, NULL, '', 1, 0, 'F', '0', '0', 'wxma:operations:edit', '#', 'admin', '2026-09-07 00:00:00', '', NULL, ''),
(2105, '查询安全检测结果', 2091, 1, '', NULL, NULL, '', 1, 0, 'F', '0', '0', 'wxma:operations:query', '#', 'admin', '2026-09-07 00:00:00', '', NULL, ''),
(2106, '提交内容安全检测', 2091, 2, '', NULL, NULL, '', 1, 0, 'F', '0', '0', 'wxma:operations:edit', '#', 'admin', '2026-09-07 00:00:00', '', NULL, ''),
(2107, '查询小程序数据', 2092, 1, '', NULL, NULL, '', 1, 0, 'F', '0', '0', 'wxma:operations:query', '#', 'admin', '2026-09-07 00:00:00', '', NULL, ''),
(2108, '查询发货信息', 2093, 1, '', NULL, NULL, '', 1, 0, 'F', '0', '0', 'wxma:operations:query', '#', 'admin', '2026-09-07 00:00:00', '', NULL, ''),
(2109, '维护发货信息', 2093, 2, '', NULL, NULL, '', 1, 0, 'F', '0', '0', 'wxma:operations:edit', '#', 'admin', '2026-09-07 00:00:00', '', NULL, '');

INSERT INTO `sys_role_menu` (`role_id`, `menu_id`) VALUES
(2, 2071), (2, 2072), (2, 2073), (2, 2074), (2, 2075), (2, 2076),
(2, 2077), (2, 2078), (2, 2079), (2, 2080), (2, 2081), (2, 2082), (2, 2083), (2, 2084),
(2, 2085), (2, 2086), (2, 2087), (2, 2088), (2, 2089), (2, 2090), (2, 2091), (2, 2092),
(2, 2093), (2, 2094), (2, 2095), (2, 2096), (2, 2097), (2, 2098), (2, 2099), (2, 2100),
(2, 2101), (2, 2102), (2, 2103), (2, 2104), (2, 2105), (2, 2106), (2, 2107), (2, 2108), (2, 2109);
